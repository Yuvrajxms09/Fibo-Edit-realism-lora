...
MODEL_PATH = "/models"
volume = modal.Volume.from_name("fibo-edit-assets", create_if_missing=True)
...
@app.function(image=image, secrets=[modal.Secret.from_name("huggingface-secret")], timeout=18000)
def download_models():
    models_config = [
           {
            "model_id": "briaai/fibo_edit_character_consistency_lora",
            "local_dir": "fibo_edit_character_consistency_lora"
        },
            {
            "model_id": "briaai/Fibo-Edit",
            "local_dir": "Fibo-Edit"
        },
            {
